					...
					<dl class="cf">
						<dt class="title">
							...
							<select class="" name="country_1">
								...
								<option value="1" %val:usr:country_1:1%>日本</option>
								<option value="2" %val:usr:country_1:2%>台湾</option>
								<option value="3" %val:usr:country_1:3%>韓国</option>
								<option value="4" %val:usr:country_1:4%>香港</option>
								<option value="5" %val:usr:country_1:5%>中国</option>
								<option value="6" %val:usr:country_1:6%>ベトナム</option>
								<option value="7" %val:usr:country_1:7%>インドネシア</option>
								<option value="8" %val:usr:country_1:8%>ネパール</option>
								<option value="9" %val:usr:country_1:9%>インド</option>
								<option value="10" %val:usr:country_1:10%>フィリピン</option>
								<option value="11" %val:usr:country_1:11%>モンゴル</option>
								<option value="12" %val:usr:country_1:12%>スリランカ</option>
								<option value="13" %val:usr:country_1:13%>カンボジア</option>
								<option value="14" %val:usr:country_1:14%>タイ</option>
								<option value="15" %val:usr:country_1:15%></option>
								<option value="16" %val:usr:country_1:16%></option>
								<option value="17" %val:usr:country_1:17%></option>
								<option value="18" %val:usr:country_1:18%>ニュージーランド</option>
								<option value="19" %val:usr:country_1:19%>オーストリア</option>
								<option value="20" %val:usr:country_1:20%>モロッコ</option>
								<option value="21" %val:usr:country_1:21%>ガーナ</option>
								<option value="22" %val:usr:country_1:22%>ケニア</option>
								<option value="23" %val:usr:country_1:23%>トーゴ</option>
								<option value="24" %val:usr:country_1:24%>ナイジェリア</option>
								<option value="25" %val:usr:country_1:25%>モザンビーク</option>
								<option value="26" %val:usr:country_1:26%>タンザニア</option>
								<option value="27" %val:usr:country_1:27%>南アフリカ</option>
								<option value="28" %val:usr:country_1:28%>トーゴ</option>
								<option value="29" %val:usr:country_1:29%>ウガンダ</option>
								<option value="30" %val:usr:country_1:30%></option>
								<option value="31" %val:usr:country_1:31%></option>
								<option value="32" %val:usr:country_1:32%></option>
								<option value="33" %val:usr:country_1:33%>カナダ</option>
								<option value="34" %val:usr:country_1:34%>アメリカ合衆国</option>
								<option value="35" %val:usr:country_1:35%>メキシコ</option>
								<option value="36" %val:usr:country_1:36%>コロンビア</option>
								<option value="37" %val:usr:country_1:37%>エクアドル</option>
								<option value="38" %val:usr:country_1:38%>コスタリカ</option>
								<option value="39" %val:usr:country_1:39%>ボリビア</option>
								<option value="40" %val:usr:country_1:40%>ブラジル</option>
								<option value="41" %val:usr:country_1:41%>アルゼンチン</option>
                                <option value="42" %val:usr:country_1:42%>ペルー</option>
								<option value="43" %val:usr:country_1:43%>ホンジュラス</option>
								<option value="44" %val:usr:country_1:44%></option>
								<option value="45" %val:usr:country_1:45%></option>
								<option value="46" %val:usr:country_1:46%>アイスランド</option>
								<option value="47" %val:usr:country_1:47%>イギリス</option>
								<option value="48" %val:usr:country_1:48%>イギリス/スコットランド</option>
								<option value="49" %val:usr:country_1:49%>イギリス/ウェールズ</option>
								<option value="50" %val:usr:country_1:50%>デンマーク</option>
								<option value="51" %val:usr:country_1:51%>フィンランド</option>
								<option value="52" %val:usr:country_1:52%>ポルトガル</option>
								<option value="53" %val:usr:country_1:53%>スペイン</option>
								<option value="54" %val:usr:country_1:54%>スペイン/カタルーニャ</option>
								<option value="55" %val:usr:country_1:55%>フランス</option>
								<option value="56" %val:usr:country_1:56%>ベルギー</option>
								<option value="57" %val:usr:country_1:57%>オランダ</option>
								<option value="58" %val:usr:country_1:58%>ドイツ</option>
								<option value="59" %val:usr:country_1:59%>スイス</option>
								<option value="60" %val:usr:country_1:60%>イタリア</option>
								<option value="61" %val:usr:country_1:61%>オーストリア</option>
								<option value="62" %val:usr:country_1:62%>チェコ</option>
								<option value="63" %val:usr:country_1:63%>スロバキア</option>
								<option value="64" %val:usr:country_1:64%>ハンガリー</option>
								<option value="65" %val:usr:country_1:65%>セルビア</option>
								<option value="66" %val:usr:country_1:66%>ギリシャ</option>
								<option value="67" %val:usr:country_1:67%>ポーランド</option>
								<option value="68" %val:usr:country_1:68%>リトアニア</option>
								<option value="69" %val:usr:country_1:69%>ラトビア</option>
								<option value="70" %val:usr:country_1:70%>エストニア</option>
								<option value="71" %val:usr:country_1:71%>ベラルーシ</option>
								<option value="72" %val:usr:country_1:72%>ウクライナ</option>
								<option value="73" %val:usr:country_1:73%>アゼルバイジャン</option>
								<option value="74" %val:usr:country_1:74%>アルメニア</option>
								<option value="75" %val:usr:country_1:75%>ロシア</option>
								<option value="76" %val:usr:country_1:76%>トルコ</option>
								<option value="77" %val:usr:country_1:77%>ジョージア</option>
								<option value="78" %val:usr:country_1:78%>キルギスタン</option>
								<option value="79" %val:usr:country_1:79%>モルドバ</option>
								<option value="80" %val:usr:country_1:80%></option>
							</select>
							<br>
						</dd>
					</dl>
